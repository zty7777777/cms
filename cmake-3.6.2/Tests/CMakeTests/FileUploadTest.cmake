file(REMOVE_RECURSE "/soft/cmake-3.6.2/Tests/CMakeTests/uploads")

if(EXISTS "/soft/cmake-3.6.2/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/soft/cmake-3.6.2/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/soft/cmake-3.6.2/Tests/CMakeTests/uploads")

set(filename "/soft/cmake-3.6.2/Tests/CMakeTests/FileDownloadInput.png")
set(urlbase "file:///soft/cmake-3.6.2/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/soft/cmake-3.6.2/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/soft/cmake-3.6.2/Tests/CMakeTests/uploads/file2.png"
